...
import { beneficiaryApplicationsRouter } from './routes/beneficiary-applications.routes';
...
import { donorRecordsRouter }          from './routes/donor-records.routes';
...
app.use('/api/v1/beneficiary-applications', beneficiaryApplicationsRouter);
...
app.use('/api/v1/donor-records',           donorRecordsRouter);
