  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h2 className="text-base sm:text-lg font-bold text-slate-800 flex items-center justify-center sm:justify-start gap-2"><Shield className="text-primary-500" /> Role Management</h2>
      </div>
