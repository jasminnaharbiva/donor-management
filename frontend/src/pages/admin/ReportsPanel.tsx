...
export default function ReportsPanel() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-lg sm:text-xl font-bold text-slate-800 flex items-center justify-center sm:justify-start gap-2"><BarChart3 className="text-primary-500" /> Reports & Analytics</h2>
